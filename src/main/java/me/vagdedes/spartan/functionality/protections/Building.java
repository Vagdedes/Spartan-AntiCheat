...
public class Building {
    ...
    private static final Enums.HackType[] concerningHackTypes;
    ...
    static {
        ...
        ArrayList<Enums.HackType> list = new ArrayList<>(hackTypes.length);
        ...
        concerningHackTypes = list.toArray(new Enums.HackType[0]);
    }
