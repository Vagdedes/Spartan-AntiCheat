package me.vagdedes.spartan.functionality.important;
...
public class Permissions {
    ...
    public static boolean has(Player p, Enums.Permission permission) {
        ...
        if (Config.settings.exists("Important.enable_permissions") && !Config.settings.getBoolean("Important.enable_permissions")) {
            return true;
        }
